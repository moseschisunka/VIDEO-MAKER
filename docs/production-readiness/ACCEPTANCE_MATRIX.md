...
| `OPS-06` | Authored UTF-8 manifest/playbook/config text survives loading without mojibake | cross-platform loader contract and live UI check | `PASS` | [`evidence/PR-10G.md`](evidence/PR-10G.md) — 3 release-blocking regression tests, live Backlot creation-modal verification, and supported run `33726592541` |
