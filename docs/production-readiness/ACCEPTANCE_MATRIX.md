...
| `RUN-05` | Remotion TypeScript/build/composition check passes | Remotion | `PASS` | [`evidence/PR-10G-remotion-clean-build-ci.json`](evidence/PR-10G-remotion-clean-build-ci.json), [`evidence/PR-10G-remotion-compositions-ci.txt`](evidence/PR-10G-remotion-compositions-ci.txt), latest supported run `33733699579` |
| `RUN-06` | Remotion undefined-variable regression and golden render pass | Remotion | `PASS` | [`evidence/PR-200.md`](evidence/PR-200.md), [`evidence/PR-10G-container-render-ci.json`](evidence/PR-10G-container-render-ci.json) — regression and supported six-composition container still matrix pass in latest run `33733699579` |
...
| `OPS-05` | Container starts, reports health, and renders local smoke fixture | container test | `PASS` | [`evidence/PR-10G-container-render-ci.json`](evidence/PR-10G-container-render-ci.json) — latest supported run `33733699579` validates authenticated health and six non-empty in-image Remotion stills |
| `OPS-06` | Authored text, creation-wizard interaction, and library work-order state remain precise across supported clients | cross-platform loader/UI contract and live browser check | `PASS` | [`evidence/PR-10G.md`](evidence/PR-10G.md), [`evidence/PR-1013.md`](evidence/PR-1013.md), and [`evidence/PR-1014.md`](evidence/PR-1014.md) — authored-text/wizard contracts, manifest-aware card/aggregate state, live Backlot modal/keyboard/library/filter verification, and supported run `33733699579` on `6b59d8e`; source checkpoint `58439f9` supported rerun pending |
