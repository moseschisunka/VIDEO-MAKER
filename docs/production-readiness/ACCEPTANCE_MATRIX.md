...
| `OPS-06` | Authored text, creation-wizard interaction, and library work-order state remain precise across supported clients | cross-platform loader/UI contract and live browser check | `PARTIAL` | [`evidence/PR-10G.md`](evidence/PR-10G.md), [`evidence/PR-1013.md`](evidence/PR-1013.md), [`evidence/PR-1014.md`](evidence/PR-1014.md), and [`evidence/PR-1018.md`](evidence/PR-1018.md) — authored-text/wizard contracts, manifest-aware card/aggregate state, and historical supported Backlot modal/keyboard/library/filter verification pass; the canonical screenshot/simulation fixture path was corrected locally and awaits supported-CI rerun |
