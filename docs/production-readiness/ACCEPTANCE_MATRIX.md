...
| `OPS-06` | Authored text and creation-wizard interaction remain precise across supported clients | cross-platform loader/UI contract and live browser check | `PASS` | [`evidence/PR-10G.md`](evidence/PR-10G.md) — 7 release-blocking regression tests, live Backlot creation-modal/keyboard verification, and supported run `33730564062`; catalog compatibility and visible run-start failures are included |
