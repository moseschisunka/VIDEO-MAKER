...
| Current local corrective rerun | PASS (Windows diagnostic; supported CI pending) | Checkpoint `03789db` — the same release-blocker selector plus the new provider-alias regression → **1,311 passed, 5 skipped, 1 deselected, 1 warning** in 341s; this is local evidence only until the checkpoint is published and CI completes |
