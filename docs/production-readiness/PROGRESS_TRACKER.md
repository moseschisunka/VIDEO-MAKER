...
| Next task | Publish and verify `PR-1016`/`PR-1017`/`PR-1018`/`PR-1019`/`PR-1020`/`PR-1021`/`PR-1022` in supported CI, then close the external `PR-10G` blockers (deployment rollback, trusted edge, monitoring/paging, and frozen release candidate) |
