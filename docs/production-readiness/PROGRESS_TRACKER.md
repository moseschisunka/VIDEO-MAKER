...
| TTS batch/sample/timestamp controls used truthiness and sample mode could bypass required batch approval | P0 | 5, 10 | `PR-1031` | Audio/pipeline | Malformed TTS controls, batch/sample gate, segments, and operation regressions | `IMPLEMENTED locally; supported CI pending` | [`evidence/PR-1031.md`](evidence/PR-1031.md) |
| Motion guidance could be truthy-coerced during cost estimation | P1 | 10 | `PR-1032` | Media/operations | Malformed motion guidance and default-cost regressions | `IMPLEMENTED locally; supported CI pending` | [`evidence/PR-1032.md`](evidence/PR-1032.md) |
| Selector operation and audiovisual policy controls were not uniformly fail-closed | P0 | 3, 6, 8, 10 | `PR-1033` | Media/provider/QA | Selector operation, ranking, motion, watermark, instrumental, and production-control regressions | `IMPLEMENTED locally; supported CI pending` | [`evidence/PR-1033.md`](evidence/PR-1033.md) |
| Provider-declared top-level booleans could still be coerced inside individual tools | P0 | 3, 5, 6, 7, 8, 10 | `PR-1034` | Provider/QA | Shared BaseTool schema-boundary regressions across audiovisual providers | `IMPLEMENTED locally; supported CI pending` | [`evidence/PR-1034.md`](evidence/PR-1034.md) |
| Shared boolean guard initially broke the structured character-review revise contract | P1 | 9, 10 | `PR-1035` | QA/media | Structured character report and strict review regression | `IMPLEMENTED locally; supported CI pending` | [`evidence/PR-1035.md`](evidence/PR-1035.md) |
| Manifest/checkpoint approval flags and Backlot stage requests accepted coercible non-boolean values | P0 | 9, 10 | `PR-1036` | Pipeline/backend/QA | Direct writer, manifest handoff, and HTTP model malformed-approval regressions | `IMPLEMENTED locally; supported CI pending` | [`evidence/PR-1036.md`](evidence/PR-1036.md) |
