...
| `PR-1001` | Include non-Python package data | `PR-1000` | `IMPLEMENTED` | OpenMontage execution agent | [`evidence/PR-1001.md`](evidence/PR-1001.md) — tracked curated Remotion fixtures are packaged; generated/user media are excluded; supported CI verification pending |
